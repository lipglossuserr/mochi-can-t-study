 ...
 * `components/tasks/DeleteTaskDialog.tsx`, reused here instead of a
 * bespoke modal.
 */
function DeleteGoalDialog({ goal, deleting, onConfirm, onCancel }: DeleteGoalDialogProps) {
  return (
    <AnimatePresence>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          <h3 className="font-display text-lg font-semibold text-ink">Delete this goal?</h3>
          <p className="mt-2 font-body text-sm text-ink/60">
            "{goal.title}" will be permanently removed. This can't be undone.
          </p>
